...
func drawFirstPageHeader(
	...
	if file.Title != "" {
		...
		p.CellFormat(0, 10, file.Title, "", 1, "C", false, 0, "")
	}

	if file.Subtitle != "" {
		p.SetFont(cfg.FontName, "", 14)
		p.CellFormat(0, 8, file.Subtitle, "", 1, "C", false, 0, "")
	}

	if file.GeneratedBy != "" {
		p.SetFont(cfg.FontName, "", 12)
		p.CellFormat(0, 8, "Generated By: "+file.GeneratedBy, "", 1, "R", false, 0, "")
	}
...
func drawTable(
	...
	colWidths := calculateColumnWidths(p, len(file.Headers))

	drawTableHeader(p, file.Headers, colWidths, cfg)
	...
	for _, row := range file.Rows {
		...
		drawTableRow(p, row, colWidths, rowHeight, cfg)
	}
}
...
func drawTableHeader(
	...
	for i, header := range headers {
		p.CellFormat(colWidths[i], 8, header, "1", 0, "C", false, 0, "")
	}
...
func drawTableRow(
	...
	for i := range colWidths {
		...
		p.CellFormat(colWidths[i], rowHeight, value, "1", 0, "L", false, 0, "")
	}
